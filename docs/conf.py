...
# -*- coding: utf-8 -*-
#
# resgen documentation build configuration file, created by
...
latex_documents = [
    (
        master_doc,
        "resgen.tex",
        "Resgen Documentation",
        "Reservoir Genomics Inc.",
        "manual",
    )
]
...
man_pages = [(master_doc, "resgen", "Resgen Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "resgen",
        "A repository for large genomic datasets.",
        "Miscellaneous",
    )
]
